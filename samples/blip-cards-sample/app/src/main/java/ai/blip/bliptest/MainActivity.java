...
public class MainActivity extends AppCompatActivity {
    ...
    public void opcoes() {
        ...
        option3.setLabel(new DocumentContainer(new PlainText("Texto")));
        option3.setOrder(3);
        ...
        option8.setLabel(new DocumentContainer(new PlainText("Media Áudio")));
        option8.setOrder(8);
        DocumentSelectOption option9 = new DocumentSelectOption();
        option9.setLabel(new DocumentContainer(new PlainText("Media Vídeo")));
        option9.setOrder(9);
        ...
        option11.setLabel(new DocumentContainer(new PlainText("Media Documento")));
        ...
        select.setHeader(new DocumentContainer(new PlainText("Selecione uma opção")));
